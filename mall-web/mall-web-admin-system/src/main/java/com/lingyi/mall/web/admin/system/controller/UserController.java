...
public class UserController {
    ...
    public ServerResponse<List<UserVO>> getListByPageAndParam(@ParameterObject @Valid UserQuery userParam) {
    ...
    public ServerResponse<List<RoleVO>> getRoleList(@ParameterObject @Valid RoleQuery roleQuery) {
