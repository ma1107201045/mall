package com.lingyi.mall.biz.system.controller;
...
public class MbsUserController {
    ...
    @Operation(summary = "查询用户信息", description = "按照用户名称查询")
    @Parameter(description = "用户名称", required = true, example = "zhangsan")
    @GetMapping
    public ServerResponse<MbsUserAndPermissionsVO> getUserAndPermissionsByUserName(String userName) {
        return ServerResponse.success(mbsUserService.getUserAndPermissionsByUserName(userName));
    }
}
