...
public interface SmsFeign {
    ...
    @GetMapping
    ServerResponse<Void> sendCaptcha(@RequestBody SmsCaptchaSendReqDTO captchaReqDTO);
    ...
    ServerResponse<Void> verifyCaptcha(@RequestBody SmsCaptchaVerifyReqDTO captchaVerifyDTO);
